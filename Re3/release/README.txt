...
This release is more suited for developers as I haven't really made anything convienent or easy.
...
**Dynamic lighting (directional lights) is broken. I think it has to due with floating point accuracy.
This has driven me crazy and I've almost given up as it works with every test program I write.

**Skinned geometry is jagged / glitchy, I suspect it has to do with floating point accuracy.
...
Call ./txdcnv [gta3 root] [output root].
...
I haven't commited anything yet and all the new stuff is untracked.
